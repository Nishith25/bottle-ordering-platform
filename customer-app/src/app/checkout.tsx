...
export default function CheckoutScreen() {
  ...
  const [
    ...
    useState<DeliverySlotAvailability | null>(
      null
    );
  ...
  const handleApplyCoupon =
    async () => {
      ...
      if (
        ...
        setCouponError(
          "Add bottles before applying a coupon."
        );
  ...
  const handleContinue = () => {
    if (
      ...
      Alert.alert(
        ...
        "Enter a valid address, check your pincode and select an available delivery date and slot."
      );
      ...
      >
        ...
        >
          ...
          >
            <View
              style={
                styles.slotHeadingRow
              }
            >
              <View
                style={
                  styles.slotHeadingContent
                }
              >
                <Text
                  style={
                ...
                >
                  Live availability is checked for your selected date.
                </Text>
              </View>
            ...
            {!serviceableLocation ? (
              <SlotInformation
                ...
                message="Check your delivery pincode before choosing a slot."
              />
            ) : !selectedDate ? (
              <SlotInformation
                icon="calendar-outline"
                message="Select a delivery day to view live slot availability."
              />
            ) : slotsLoading ? (
              <View
                style={
                  styles.slotLoadingCard
                }
              >
                <ActivityIndicator
                  size="small"
                ...
                >
                  Checking live delivery-slot availability…
                </Text>
              </View>
            ) : slotsError ? (
              <View
                style={
                  styles.slotErrorCard
                }
              >
                <Ionicons
                ...
                <View
                  style={
                    styles.slotErrorContent
                  }
                >
                  <Text
                    style={
                      styles.slotErrorTitle
                    }
                  >
              ...
              <SlotInformation
                icon="time-outline"
                message="No delivery slots are configured for this date."
              />
            ) : (
              <View
                style={
                      ...
                      >
                        <View
                          style={[
                            ...
                            selected &&
                              styles.slotIconSelected,

                            disabled &&
                              styles.slotIconDisabled,
                          ]}
                        >
                          <Ionicons
                            name="time-outline"
          ...
          >
            ...
            >
              Coupon discounts apply to the bottle subtotal. The backend checks the code again before the order is created.
            </Text>

            {appliedCoupon ? (
              <View
                style={
                  styles.appliedCouponCard
                }
              >
                <View
                  style={
